# mocking is used to test a web applcation which is down but we need to test the project.


from contextlib import contextmanager
from errno import WSASYSNOTREADY
import unittest
import employee_mock

from employee_mock import Employee
...
class TestEmployee(unittest.TestCase):
    ...
    def setUp(self):
        print("\nsetUp")
        self.emp_1 = Employee("raghu", 'ram', 5000)
        self.emp_2 = Employee("sundhar", "pitchai", 10000)
    ...
    def test_month(self):
        self.emp_1.month("June")
        self.emp_2.month("April")
        print("testing mon_sch")
    ...
    def test_monthly_schedule(self):
        ...
        with patch('employee_mock.requests.get') as mocked_get:
            ...
            # mocked_get.return_value.text = "Success"  ## we don't need this line. 
